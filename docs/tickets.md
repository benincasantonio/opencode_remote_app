...
3. Shared setup/generate job; analyze, custom_lint, and test run in parallel from generated artifacts.
...
- [ ] Pub/build caches used; analyze / custom_lint / test parallel after setup
